    ...
    <Layout>
      ...
      <div>
        ...
        <p>
          ...
          anymore since my time is very limited now a days with the family.
        </p>
        ...
        <p>
          ...
          create the Javascript to help power those interfaces. I have even
          bridged complex systems that interact with a universal api for native
          to html access. I also specialize in accessibility to make a product
          ada compliant and usable for the majority.
        </p>
